...
public class ParserTests {
	...
	public void testRHSAssignment(){
		//arithmetic expression, optionally followed by a comparison operator and another arithmetic expression.
		...
		runtest("module Test{ public int function_name() { a <= a; } }");
		runtest("module Test{ public int function_name() { a >= true; } }"); 
		runtest("module Test{ public int function_name() { -1*-\"x\" + true*-[x=1] >= -x(y=1)*-3 - -x(y=1)*[a=1]; } }"); 
	}
	
	@Test
	public void testArithmeticExpression(){
		//either an arithmetic expression, followed by an additive operator, followed by a term; or just a term
		runtest("module Test{ public int test() { -1*-\"x\" + true*-[x=1]; } }");
		runtest("module Test{ public int test() { -x(y=1)*-3 - -x(y=1)*[a=1]; } }");
	}
	
	@Test
	public void testTerm(){
		//term followed by a multiplicative operator followed by a factor
		runtest("module Test{ public int test() { -1*-\"x\"; } }"); 
		runtest("module Test{ public int test() { -true*-[x=1]; } }");
		runtest("module Test{ public int test() { -x(y=1)*-3; } }");
		runtest("module Test{ public int test() { -x(y=1)*-[a=1]; } }");
	}
